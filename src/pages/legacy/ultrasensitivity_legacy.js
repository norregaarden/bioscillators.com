...
const vars = [
    ...
    }, 
    {
        ...
        c: 'green',
        i: 0,
        d: 'dEdt 	= k5*Y - k6*E - ka*SO*E + kd*ESO + kc*ESO '
    },
    {
        l: 'SO',
        c: 'black',
        i: 0.1,
        d: 'dSOdt	= -ka*SO*E + kd*ESO + k_c*PS1'
    },
    {
        l: 'S1',
        c: 'gray',
        i: 0.9,
        d: 'dS1dt	= -k_a*S1*P + k_d*PS1 + kc*ESO '
    },
    {
        l: 'ESO',
        c: 'darkolivegreen',
        i: 0.01,
        d: 'dESOdt	= ka*SO*E - kd*ESO - kc*ESO'
    },
    {
        l: 'PS1',
        c: 'khaki',
        i: 0.01,
        d: 'dPS1dt	= k_a*S1*P - k_d*PS1 - k_c*PS1 '
    },
    {
        l: 'P',
        c: 'yellow',
        i: 0,
        d: 'dPdt 	= -(k_a*S1*P - k_d*PS1 - k_c*PS1) '
    }
]

const sim = math.parser()
sim.scope.dt = 0.00001
sim.scope.tmax = 0.1
sim.evaluate('k1 = 0.01')
sim.evaluate('k3 = 1')
sim.evaluate('k5 = 0.0005')
sim.evaluate('k2 = k4 = k6 = 0.1')
sim.evaluate('ka = k_a = 1000')
sim.evaluate('kd = k_d = 10')
sim.evaluate('kc = k_c = 10')
